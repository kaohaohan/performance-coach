...
export const calendar: CalendarMessages = {
  ...
  "calendar.assign.editCopy": "編輯課表",
  "calendar.assign.savedOne": "以原課表指派給 {count} 位學員",
  "calendar.assign.savedOther": "以原課表指派給 {count} 位學員",
  "calendar.assign.copyNotice": "正在編輯「{name}」。建立並指派後會產生一份新課表，原課表和先前的指派都不會變更。",
  ...
  "calendar.field.instruction": "自訂目標",
  "calendar.field.instructionPlaceholder": "AMAP、30 秒、10–12",
  "calendar.field.reps": "次數",
  "calendar.field.coachCue": "教練提示（選填）",
  "calendar.field.coachCuePlaceholder": "肩膀不要聳起，頂端停一秒",
  ...
  "calendar.field.repsIncrement": "每週 +1 次",
  "calendar.field.repsIncrementHint": "為一位運動員複製或重複課表時多加一次，與每週 +1 組互不影響。",
