...
export const calendar = {
  ...
  "calendar.field.repsIncrement": "Weekly +1 rep",
  "calendar.field.repsIncrementHint": "Adds one rep when you copy or repeat this workout for one athlete, independently of weekly +1 set.",
