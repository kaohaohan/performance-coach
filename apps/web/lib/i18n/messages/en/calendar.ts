...
export const calendar = {
  ...
  "calendar.field.repsIncrement": "Weekly extra reps",
  "calendar.field.repsIncrementHint": "How many reps to add when you copy or repeat this workout for one athlete. Leave empty for none. Independent of weekly +1 set.",
  ...
  "calendar.repeatWeek.repsPreview": "{sourceReps} → {suggestedReps} reps",
