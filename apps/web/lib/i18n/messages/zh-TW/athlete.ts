...
export const athlete: AthleteMessages = {
  ...
  "athlete.today.showMonthGrid": "顯示月曆",
  "athlete.today.hideMonthGrid": "隱藏月曆",
  "athlete.today.previousMonth": "上個月",
  "athlete.today.nextMonth": "下個月",
  ...
  "athlete.plan.mixedSets": "{count} 組，處方不同",
  "athlete.coachCue": "教練提示：",
  "athlete.watchVideo": "觀看示範",
  "athlete.today.showCoachCue": "顯示教練提示",
  "athlete.today.hideCoachCue": "隱藏教練提示",
  ...
  "athlete.session.previousExercise": "上一個動作",
  "athlete.session.backToOverview": "返回動作列表",
  "athlete.session.exercisePosition": "{current}／{total}",
  "athlete.session.finish": "完成",
  "athlete.session.colSet": "組",
  "athlete.session.colTarget": "目標",
