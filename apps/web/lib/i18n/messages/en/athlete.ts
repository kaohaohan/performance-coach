...
export const athlete = {
  ...
  "athlete.today.showMonthGrid": "Show month",
  "athlete.today.hideMonthGrid": "Hide month",
  "athlete.today.previousMonth": "Previous month",
  "athlete.today.nextMonth": "Next month",
  ...
  "athlete.plan.mixedSets": "{count} sets, mixed",
  "athlete.coachCue": "Coach cue:",
  "athlete.watchVideo": "Watch demo",
  "athlete.today.showCoachCue": "Show coach cue",
  "athlete.today.hideCoachCue": "Hide coach cue",
  ...
  "athlete.session.coachCueLabel": "Coach cue",
  "athlete.session.coachCuePlaceholder": "e.g. Keep your shoulders down; pause at the top.",
  "athlete.session.noCoachCue": "No coach cue set",
  "athlete.session.addCoachCue": "Add cue",
  "athlete.session.editCoachCue": "Edit cue",
  "athlete.session.cancelCoachCue": "Cancel",
  "athlete.session.saveCoachCue": "Save cue",
  "athlete.session.progressSummary": "{completed} of {total} sets complete",
  "athlete.session.nextExercise": "Next exercise",
  "athlete.session.previousExercise": "Previous exercise",
  "athlete.session.backToOverview": "Back to list",
  "athlete.session.exercisePosition": "{current} / {total}",
  "athlete.session.finish": "Finish",
  "athlete.session.colSet": "Set",
  "athlete.session.colTarget": "Target",
